'''
Program: Calendar month program 

Author: Felix 

Description: Calendar month program displaying the month, dates and the seven days of the week 
...
while not terminate:
    ...
    if month == -1:
        terminate = True 
        print('You are welcome again to use our program!')
    else:
        ...
        elif leap_year: # month of February 
...
## More updates needed to solve the current bugs. The print format is still not that well arranged. 