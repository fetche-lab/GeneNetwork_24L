...
# ----------------------------------------------------------------------
# 01. Make it a Standalone Script
# ----------------------------------------------------------------------
if __name__ == "__main__":
    # Example usage (replace with actual file paths)
    geno_file = "genotype_data.txt"   # Path to your genotype data file
    marker_file = "marker_data.txt"   # Path to your marker data file
    output_file = "merged_output.txt" # Desired path for the output file

    convert_genotype_files(geno_file, marker_file, output_file)
