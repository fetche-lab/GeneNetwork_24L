...
input_dir <- "/home/fetche-lab/Desktop/gn_remote/GeneNetwork_24L/PheWAS_Project/Data/Raw/phewas01/MEIS1_MICE"
output_dir <- "/home/fetche-lab/Desktop/gn_remote/GeneNetwork_24L/PheWAS_Project/Data/Processed/phewas01/MEIS1_MICE"
output_dir1 <- "/home/fetche-lab/Desktop/gn_remote/GeneNetwork_24L/PheWAS_Project/Data/Processed/phewas01/MEIS1_MICE/filtered"
...
process_file <- function(file_path) {
  ...
  phewas_data <- data %>%
    filter(Symbol == "Meis1" & P_value_of_MAX < 0.05 & grepl("restless leg syndrome", Description, ignore.case=TRUE)) %>%
...
if (nrow(combined_data) > 0) {
  write.csv(combined_data, file.path(output_dir1, "phewas_meis1_combined.csv"), row.names=FALSE)
